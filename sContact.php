                ...
                <nav class="navbar navbar-default" style="width:47.5%;">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="padding-top: 0px; margin-top: 0px;">
                        <ul class="nav navbar-nav navbar-right wow fadeInLeft animated" data-wow-delay=".5s">
                            ...
                            <li><a href="http://localhost/ELearning/sContact.php" class="active">Contact</a></li>
...
<?php if(empty($_REQUEST))
{
    ?>
                    <div class="form">
                        ...
                        <h1 style="padding:15px;">Send Query</h1>

                        <?php
                        $id = $_SESSION['Sid'];
                        echo "<form action='http://localhost/ELearning/sContact.php' method='post'>";
                        ?>

                        <div class="field-wrap" style="padding-bottom:25%;">
                            <label>
                                Query to the admin * 
                            </label>

                            <textarea name="feed" cols="50" rows="5" maxlength="300" class="textinput" style="padding-bottom:10px;" required>
                            </textarea>
                        </div>  

                        <div class="field-wrap" style="padding-top:5%;">
                            <button type="submit" class="button button-block" value="Create"/>Send Query</button>    
                        </div>
...
<?php
    ...
    $feed= $_REQUEST['feed'];
    $d= date('Y-m-d');
    $query=" INSERT INTO `feedback`(`Actor`, `Actor_id`, `Feed`,`Posted_date`) VALUES ('$actor','$sid','$feed','$d');";
