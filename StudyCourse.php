                   ...
                   <div class="header" style="height:75px;">
                    ...
                    <div class="best">
                       <!-- <center><h3>Study course</h3></center> -->
                        ...
                        <div class="mpdf" style="min-height:auto;">
                            <div>
                                <div class="vertical-menu" style="float:left;margin-left:0px;width:15%;padding-left: 2%;">
                                    <a href="StudyCourse.php" class="active">Home</a>
                                    <?php
                                    for ($i = 1; $i <= $n; $i++) {
                                        echo "<a href=http://localhost/ELearning/ViewCourseNotes.php?cid=$subid&mod=$i> Module $i </a>";
                                    }
                                     echo "<a href=http://localhost/ELearning/ViewCourseNotes.php?cid=$subid&mod=-5> Master Test </a>";
                                    echo "</div>";
                                    ?>
                            ...
                            <div id="pdf" style="float:right; margin-right: 2%; margin-top: 0px;">
                                <object id="pdf_content" width="1000px" height="500px" type="application/pdf" trusted="yes" application="yes" title="Assembly" data="http://localhost/ELearning/uploads/notes/Rules.pdf?#zoom=100&scrollbar=1&toolbar=0&navpanes=0">
